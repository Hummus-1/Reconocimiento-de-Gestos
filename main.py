...
# Función que obtene el ángulo del defecto de convexidad
def angle(s,e,f):
    v1 = [s[0]-f[0],s[1]-f[1]]
    v2 = [e[0]-f[0],e[1]-f[1]]
...
# Función que obtiene el contorno de la mano y el hull
...
# Función que detecta los gestos
...
while True:
    ...
    try:
        ...
        if defects is not None:
            ...
            # Por cada defecto de convexidad hallamos sus puntos start, end, far, su ángulo y su profundidad
            ...
            # Motrar que detectamos (nº de dedos y gesto)
